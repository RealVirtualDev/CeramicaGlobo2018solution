...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Gruppo", fieldName: "gruppo", columnType: "string", width: "auto", visible: true, columnName: "c3", style: { "text-align": "left", "padding-left": "20px" } },
