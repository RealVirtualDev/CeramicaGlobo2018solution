...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Visibile", fieldName: "visibile", columnType: "string", width: "auto", visible: true, columnName: "c2", style: { "text-align": "left", "padding-left": "20px" } },
