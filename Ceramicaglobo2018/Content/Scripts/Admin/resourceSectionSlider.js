...
var grid;
var resourceName = "SectionSlider";
...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Sezione", fieldName: "sezione", columnType: "string", width: "auto", visible: true, columnName: "c1", style: { "text-align": "left", "padding-left": "20px" } },
