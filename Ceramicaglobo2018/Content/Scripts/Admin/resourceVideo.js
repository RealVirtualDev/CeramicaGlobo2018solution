...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Descrizione", fieldName: "descrizione", columnType: "string", width: "auto", visible: true, columnName: "c2", style: { "text-align": "left", "padding-left": "20px" } },
            { title: "File", fieldName: "file", columnType: "string", width: "auto", visible: true, columnName: "c3", style: { "text-align": "left", "padding-left": "20px" } },
            { title: "Link", fieldName: "link", columnType: "string", width: "auto", visible: true, columnName: "c4", style: { "text-align": "left", "padding-left": "20px" } },
        ...
        onbind: function (row) {
           // console.info(row);
            ...
            row['file'] = '<a target="_blank" href="' + row['file'] + '">' + row['file'] + '</a>';
