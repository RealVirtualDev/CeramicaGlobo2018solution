...
var grid;
var resourceName = "TipologieMenu";
...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Categoria", fieldName: "categorianame", columnType: "string", width: "auto", visible: true, columnName: "c2", style: { "text-align": "left", "padding-left": "20px" } },
            { title: "Visualizza in Menu", fieldName: "ismenu", columnType: "string", width: "auto", visible: true, columnName: "c3", style: { "text-align": "left", "padding-left": "20px" } },
