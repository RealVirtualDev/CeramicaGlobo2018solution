...
var grid;
var resourceName = "Sottocategorie";
...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Categoria", fieldName: "categorianame", columnType: "string", width: "auto", visible: true, columnName: "c1", style: { "text-align": "left", "padding-left": "20px" } },
        ...
        pageSize: 250, // DIMENSIONE DELLA PAGINA
        allowReorder: true,
        showtoolbar: true,
        // TOOBAR
        toolbar: {
