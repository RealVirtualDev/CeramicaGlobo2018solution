...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Titolo", fieldName: "titolo", columnType: "string", width: "auto", visible: true, columnName: "c1", style: { "text-align": "left", "padding-left": "20px" } },
            { title: "Template", fieldName: "template", columnType: "string", width: "auto", visible: true, columnName: "c2", style: { "text-align": "left", "padding-left": "20px" } },
            { title: "Link", fieldName: "link", columnType: "string", width: "auto", visible: true, columnName: "c3", style: { "text-align": "left", "padding-left": "20px" } },
            { title: "Mostra Contenuto", fieldName: "showcontent", columnType: "string", width: "auto", visible: true, columnName: "c4", style: { "text-align": "left", "padding-left": "20px" } },
            { title: "Visibile", fieldName: "visibile", columnType: "string", width: "auto", visible: true, columnName: "c4", style: { "text-align": "left", "padding-left": "20px" } },
        ...
        onbind: function (row) {
           // console.info(row);
            ...
            row['showcontent'] = row['showcontent'] == '1' ? 'Si' : 'No';
            row['visibile'] = row['visibile'] == '1' ? 'Si' : 'No';
            var template = "";
            switch (row['template']) {
                case "img2txt1":
                    template = "Template immagine grande";
                    break;
                case "imgtxt1":
                    template = "Template immagine Piccola (1 di 3 colonne)";
                    break;
                case "bannerFull":
                    template = "Template banner immagine larghezza piena (1 colonna)";
                    break;
                case "bannerFullNoText":
                    template = "Template banner immagine larghezza piena senza testi (1 colonna)";
                    break;
            }
