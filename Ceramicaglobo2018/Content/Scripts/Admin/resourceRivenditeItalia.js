...
var grid;
var resourceName = "RivenditeItalia";
...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Regione", fieldName: "regione", columnType: "string", width: "auto", visible: true, columnName: "c1", style: { "text-align": "left", "padding-left": "20px" } },
            ...
            { title: "Indirizzo", fieldName: "indirizzo", columnType: "string", width: "auto", visible: true, columnName: "c3", style: { "text-align": "left", "padding-left": "20px" } },
