...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Tipo", fieldName: "tipo", columnType: "string", width: "auto", visible: true, columnName: "c2", style: { "text-align": "left", "padding-left": "20px" } },
            { title: "Pdf", fieldName: "pdf", columnType: "string", width: "auto", visible: true, columnName: "c3", style: { "text-align": "left", "padding-left": "20px" } },
            { title: "Data", fieldName: "datestr", columnType: "string", width: "auto", visible: true, columnName: "c4", style: { "text-align": "left", "padding-left": "20px" } },
