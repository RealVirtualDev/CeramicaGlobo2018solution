...
var grid;
var resourceName = "Comunicazione";
...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Sottotitolo", fieldName: "sottotitolo", columnType: "string", width: "auto", visible: true, columnName: "c2", style: { "text-align": "left", "padding-left": "20px" } },
            { title: "Pdf", fieldName: "pdf", columnType: "string", width: "auto", visible: true, columnName: "c3", style: { "text-align": "left", "padding-left": "20px" } },
            { title: "Data", fieldName: "datastr", columnType: "date", width: "auto", visible: true, columnName: "c4", style: { "text-align": "center" } },
            { title: "Visibile", fieldName: "visibile", columnType: "string", width: "auto", visible: true, columnName: "c5", style: { "text-align": "center" } },
