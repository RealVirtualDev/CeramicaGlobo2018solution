...
var grid;
var resourceName = "FinitureGruppi";
        ...
        columns: [
            ...
            // COLONNA 6 -- COLONNA BUTTON -- SOLO PULSANTI
            {
                ...
                buttons: [
                    ...
                    {
                        text: 'FINITURE',
                        commandName: 'finiture',
                        commandArgument: 'finiture',
                        style: { 'padding': '6px', 'float': 'right', 'margin-right': '10px' },
        ...
        command: function (cname, carg, row) {
            ...
            switch (carg) {
                ...
                case 'modifica':
                    ...
                    break;
                case 'finiture': {
                    window.location.href = "/admin/res-finiture?ig=" + row.itemgroup
                }
                case 'duplica':
                    // non implementato
                    break;
