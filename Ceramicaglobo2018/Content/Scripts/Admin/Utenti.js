...
var editPage = function (id) {
    ...
    let purl = "/admin/utenti/getEditor"
    localStorage.clear();
...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Nome", fieldName: "name", columnType: "string", width: "auto", visible: true, columnName: "c2", style: { "text-align": "center" } },
            { title: "Cognome", fieldName: "cognome", columnType: "string", width: "auto", visible: true, columnName: "c3", style: { "text-align": "center" } },
            { title: "Email", fieldName: "email", columnType: "string", width: "auto", visible: true, columnName: "c4", style: { "text-align": "center" } },
            { title: "Password", fieldName: "password", columnType: "string", width: "auto", visible: true, columnName: "c5", style: { "text-align": "center" } },
            { title: "Nazione", fieldName: "nazione", columnType: "string", width: "auto", visible: true, columnName: "c6", style: { "text-align": "center" } },
