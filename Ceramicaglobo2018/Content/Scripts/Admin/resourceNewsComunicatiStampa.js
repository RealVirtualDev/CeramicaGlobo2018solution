...
var grid;
var resourceName = "NewsComunicatiStampa";
...
grid = $("#grid").jltable(
    {
        ...
        columns: [
            ...
            { title: "Pdf", fieldName: "pdf", columnType: "string", width: "auto", visible: true, columnName: "c2", style: { "text-align": "left", "padding-left": "20px" } },
