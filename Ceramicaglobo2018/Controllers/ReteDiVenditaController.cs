...
{
    public class ReteDiVenditaController : Controller
    {
        ...
        //[ChildActionOnly]
        [HttpPost]
        public JsonResult getResellers()
        {
            return Json(db.RivenditeItalia.Where(x=>x.lang==LanguageSetting.Lang).ToList());
        }
    }
}